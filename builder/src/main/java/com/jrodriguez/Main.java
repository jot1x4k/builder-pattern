...
public class Main {
    public static void main(String[] args) {
        ...
        director.buildSelfServiceAppointment( "123456789", "Juan Rodriguez", "555-1234" );
        ...
        director.buildManualAppointment( "123456789", "Juan Rodriguez", "555-1234", 1L, "Dr. Perez", java.sql.Date.valueOf("2023-10-10"), java.sql.Time.valueOf("10:00:00"), 30, "Control medico", "Confirmada" );
        ...
        director.buildRescheduledAppointment(java.sql.Date.valueOf("2023-10-11"), java.sql.Time.valueOf("11:00:00"), "Reprogramada");        
    }
}